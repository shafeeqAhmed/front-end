...
// GET: Return Users
// ------------------------------------------------
mock.onGet('/apps/subscription/users').reply(config => {
...
// POST: Add new user
// ------------------------------------------------
mock.onPost('/apps/subscription/users').reply(config => {
...
// ------------------------------------------------
mock.onGet(/\/apps\/subscription\/users\/\d+/).reply(config => {
...
// ------------------------------------------------
mock.onDelete(/\/apps\/subscription\/users\/\d+/).reply(config => {
  // Get event id from URL
  let userId = config.url.substring(config.url.lastIndexOf('/') + 1)
